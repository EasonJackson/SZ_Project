...
router.get('/detail', function(req, res, next) {
	...
	rpc_client.getDetailsByZpid(id, function(response) {
		...
		splitFacts(property, 'addtional_facts');
...
function addThousandSeparator(property) {
	property['list_price'] = numbersWithCommas(property['list_price'])
	property['size'] = numbersWithCommas(property['size'])
	property['predicted_value'] = numbersWithCommas(property['predicted_value'])
}
